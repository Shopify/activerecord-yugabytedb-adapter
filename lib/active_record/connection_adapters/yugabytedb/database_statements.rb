  ...
  module ConnectionAdapters
    module YugabyteDB
      module DatabaseStatements
        ...
        # Executes an SQL statement, returning a YSQL::Result object on success
        # or raising a YSQL::Error exception otherwise.
        #
        # Setting +allow_retry+ to true causes the db to reconnect and retry
        # executing the SQL statement in case of a connection-related exception.
        # This option should only be enabled for known idempotent queries.
        #
        # Note: the YSQL::Result object is manually memory managed; if you don't
        ...
        private
          ...
          def perform_query(raw_connection, sql, binds, type_casted_binds, prepare:, notification_payload:, batch: false)
            ...
            result = if prepare
              ...
              rescue YSQL::FeatureNotSupported => error
